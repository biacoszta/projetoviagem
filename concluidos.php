            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Concluídos</h1>

                        <div class="row">
                            <?php
                                $id = $_COOKIE['idUser'];
                                $sql = "SELECT destinos.nome, destinos.valor, destinos.descricao, destinos.dias, destinos.imagem, destinosusuarios.situacao FROM destinosusuarios inner join destinos on destinos.id = destinosusuarios.idDestino where situacao = 'concluido' and idUsuario = '$id';";
                            ...
                            <div class="card col-xl-3 col-md-3 mb-4 mr-4 pt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-light"><i data-feather="heart"
                                            style="color: red;"></i></a>
                                    <a href="#" class="btn btn-light"><i data-feather="check"
