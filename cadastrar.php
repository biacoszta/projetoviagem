            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span
                                        class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $dados['nome'];?></span>
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Cadastrar destino</h1>
                        <div class="inteira" style="width: 800px;">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <label for="formGroupExampleInput2">Valor</label>
                                        <input type="text" class="form-control" placeholder="Digite o valor do destino">
                                    </div>
                                    <div class="col">
                                    <label for="formGroupExampleInput2">Dias</label>
                                        <input type="text" class="form-control" placeholder="Digite o número de dias">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <label for="formGroupExampleInput2">Descrição</label>
                                        <input type="text" class="form-control" placeholder="Descrição do destino">
                                    </div>
                                    <div class="col">
                                    <label for="formGroupExampleInput2">Imagem</label>
                                        <input type="text" class="form-control" placeholder="Imagem do destino">
                                    </div>
                                </div>
                            </div>
                            <button type="button" class="btn btn-primary btn-md mt-4" style="width: 250px;">Enviar</button>
                        </div>
                    </div>
